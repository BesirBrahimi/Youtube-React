        ...
        <div className="flex items-center justify-between w-full">
          <div className="w-full flex flex-col sm:flex-col lg:flex-row justify-between">
            <div className="flex items-center mb-4">
              ...
              <div className="w-[30%]">
                <button className="w-[100px] mt-1 h-[40px] text-white rounded-full  bg-[#0b0b0b] hover:bg-[#7f7d7d]">
                  Subscribe
                </button>
              </div>
            </div>
            <div className="sm:w-[90%] flex lg:w-[40%] ml-4 items-center justify-between">
              <p
                ...
                className="flex items-center bg-gray-100 rounded-full p-2 cursor-pointer hover:bg-gray-200"
              >
                {like ? (
              ...
              <p className="text-2xl bg-gray-100 rounded-full p-2 cursor-pointer hover:bg-gray-200">
                <BiDislike />
              </p>
              <p className="text-2xl bg-gray-100 rounded-full p-2 cursor-pointer hover:bg-gray-200">
                <RiShareForwardLine />
              </p>
              <div className="flex items-center text-2xl bg-gray-100 rounded-full p-2 cursor-pointer hover:bg-gray-200">
